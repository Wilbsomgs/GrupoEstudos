...
public class CacaNumeros {
    public static void main(String[] args) {
        ...
        for(int i = 0; i < palpites.length; i++){
            ...
            System.out.println("Número secreto: " + secretNumber);
        }
        // Depois do laço de palpites
        System.out.println("Seus palpites foram:");
        for (int i = 0; i < palpites.length; i++) {
            System.out.println("Palpite " + (i + 1) + ": " + palpites[i]);
        }
